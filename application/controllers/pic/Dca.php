...
class Dca extends CI_Controller {
	...
	public function __construct()
    {
        ...
        // Load Model
        $this->load->model('pic/Mo_dca','dca');
        $this->load->model('pic/Mo_customer','customer');
        $this->load->model('pic/Mo_pic','pic');
        $this->load->model('pic/Mo_remark','moremark');
	...
	public function index()
	{
        ...
        $this->load->view('dca/dca_pic', $data);
	...
	public function remark($id)
	{
		...
		// View
		$this->load->view('static/header_view', $head);
        $this->load->view('dca/remark_pic', $data);
        $this->load->view('static/footer_view');
	}
	...
	public function result_angket($id)
	{
		...
		// View
		$this->load->view('static/header_view', $head);
        $this->load->view('dca/result_pic', $data);
        $this->load->view('static/footer_view');
	}
