...
<head>
  ...
  <title>Login Administrator &mdash; Daily Activity Sales</title>
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
              <div class="card-header"><h4>Login DCA | Administrator Mode</h4></div>

              <div class="card-body">
                <form method="POST" action="<?php echo base_url('admin/login_admin/proses_login'); ?>" class="needs-validation" novalidate="">
