        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="text-center">
                <button class="btn btn-primary" onclick="add_user_admin()" data-toggle="tooltip" data-placement="bottom" title="Tambah User Admin">
                  ...
                  if(confirm('Apakah anda yakin akan menghapus data ini?'))
                  {
                      ...
                      $.ajax({
                          ...
                          success: function(data)
                          {
                              ...
                              document.location = "<?php echo base_url('admin/user_admin')?>";
                          },
                          error: function (jqXHR, textStatus, errorThrown)
                          {
                  ...
                  if(list_id.length > 0)
                  {
                      if(confirm('Apakah anda yakin akan menghapus '+list_id.length+' data ini?'))
                      {
                          $.ajax({
                              type: "POST",
                              data: {id:list_id},
                              url: "<?php echo site_url('admin/user_admin/ajax_bulk_delete')?>",
                              dataType: "JSON",
                              success: function(data)
                              {
                                  if(data.status)
                      ...
                      <div class="modal-body form">
                          <form action="#" id="form" class="form-horizontal">
                              ...
                              <div class="form-body">
                                  ...
                                  <div class="form-group">
                                      <label for="hak_akses" class="col-sm-12 control-label">Hak Akses</label>
                                      <div class="col-sm-12">
