        ...
        <section class="section">
          <div class="section-header">
            ...
            <script type="text/javascript">
              ...
              {
                  $.ajax({
                      url : "<?php echo site_url('pic/customer/ajax_edit')?>/" + id,
                      type: "GET",
                      dataType: "JSON",
              ...
              function delete_customer(id)
              {
                  if(confirm('Apakah anda yakin akan menghapus data ini?'))
                  {
                      ...
                      $.ajax({
                          url : "<?php echo site_url('pic/customer/ajax_delete')?>/"+id,
                          type: "POST",
                          dataType: "JSON",
                          success: function(data)
                          {
                              //if success reload ajax table
                              document.location = "<?php echo base_url('pic/customer')?>";
                          },
                          error: function (jqXHR, textStatus, errorThrown)
                          {
                  ...
                  if(list_id.length > 0)
                  {
                      if(confirm('Apakah anda yakin akan menghapus '+list_id.length+' data ini?'))
                      {
                          $.ajax({
                              type: "POST",
                              data: {id:list_id},
                              url: "<?php echo site_url('pic/customer/ajax_bulk_delete')?>",
                              dataType: "JSON",
                              success: function(data)
                              {
                                  if(data.status)
              ...
              function save()
              {
                  ...
                  if(save_method == 'add') {
                      url = "<?php echo site_url('pic/customer/ajax_add')?>";
                  } else {
                      url = "<?php echo site_url('pic/customer/ajax_update')?>";
                  }
                      ...
                      <div class="modal-body form">
                          <form action="#" id="form" class="form-horizontal">
                              ...
                              <div class="form-body">
                                  ...
                                  <div class="form-group">
                                      <label class="control-label col-md-6">Status Karyawan</label>
                                      <div class="col-md-12">
                      ...
                      <div class="modal-body">
                        <div class="table-responsive">
                              <table class="table table-sm" width="100%">
                                  ...
                                  <tr>
                                      <td class="text-right"><strong>NB/M :</strong></td>
                                      <td>&nbsp; <span id="detail_sts_member"></span></td>
                                  </tr>
                              </table>
                            </div>
                      </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body form">
                          <form id="form-filter" class="form-horizontal">
                              ...
                              <div class="form-group">
                                  <label for="fil_member" class="col-sm-12 control-label">Status Member</label>
                                  <div class="col-sm-12">
                                      <select class="form-control" name="fil_member" id="fil_member">
