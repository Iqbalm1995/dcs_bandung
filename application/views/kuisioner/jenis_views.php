      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>Pengaturan Jenis Kuisioner</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
              <div class="breadcrumb-item">Kuisioner</div>
              <div class="breadcrumb-item">Jenis Kuisioner</div>
            </div>
          </div>
            ...
            <div class="text-center">
                ...
                <button class="btn btn-primary" onclick="add_jenis_ksrn()" data-toggle="tooltip" data-placement="bottom" title="Tambah data">
            ...
            <script type="text/javascript">
              ...
              $(document).ready(function() {
                  ...
                  table = $('#table').DataTable({ 
                      ...
                      "ajax": {
                          "url": "<?php echo site_url('admin/jenis_ksrn/ajax_list')?>",
                          "type": "POST"
                      },
              ...
              function edit_jenis_ksrn(id)
              {
                  ...
                  $.ajax({
                      url : "<?php echo site_url('admin/jenis_ksrn/ajax_edit')?>/" + id,
                      type: "GET",
                      dataType: "JSON",
                      success: function(data)
                      {
                          ...
                          $('[name="id"]').val(data.id);
                          $('[name="jenis_kuisioner"]').val(data.jenis_kuisioner);
              ...
              function delete_jenis_ksrn(id)
              {
                  if(confirm('Apakah anda yakin akan menghapus data ini?'))
                  {
                      // ajax delete data to database
                      $.ajax({
                          url : "<?php echo site_url('admin/jenis_ksrn/ajax_delete')?>/"+id,
                          type: "POST",
                          dataType: "JSON",
                          success: function(data)
                          {
                              //if success reload ajax table
                              document.location = "<?php echo base_url('admin/jenis_ksrn')?>";
                          },
                          error: function (jqXHR, textStatus, errorThrown)
                          {
                  ...
                  if(list_id.length > 0)
                  {
                      if(confirm('Apakah anda yakin akan menghapus '+list_id.length+' data ini?'))
                      {
                          $.ajax({
                              type: "POST",
                              data: {id:list_id},
                              url: "<?php echo site_url('admin/jenis_ksrn/ajax_bulk_delete')?>",
                              dataType: "JSON",
                              success: function(data)
                              {
                                  if(data.status)
              ...
              function save()
              {
                  ...
                  if(save_method == 'add') {
                      url = "<?php echo site_url('admin/jenis_ksrn/ajax_add')?>";
                  } else {
                      url = "<?php echo site_url('admin/jenis_ksrn/ajax_update')?>";
                  }
                          ...
                          <form action="#" id="form" class="form-horizontal">
                              ...
                              <div class="form-body">
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-12">
                                          <input name="jenis_kuisioner" placeholder="Nama Jenis Kuisioner" class="form-control" type="text" required>
