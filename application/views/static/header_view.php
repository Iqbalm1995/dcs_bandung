...
<head>
  ...
  <title><?php echo $title_page; ?> &mdash; Daily Activity Sales</title>
...
<body>
  <div id="app">
    <div class="main-wrapper main-wrapper-1">
      ...
      }else if($this->session->userdata('status') == "logindcapic"){
          include('navbar_pic.php');
          include('sidebar_pic.php');
      }else if($this->session->userdata('status') == "logindcacus"){
          include('navbar_cus.php');
          include('sidebar_cus.php');
      }?>