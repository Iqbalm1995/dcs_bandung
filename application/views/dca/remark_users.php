      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="row">
            <div class="col-md-8">
              <!-- Start Control -->
              <a class="btn btn-dark tombolfull" href="<?php echo base_url('dca')?>" data-toggle="tooltip" data-placement="bottom" title="Kembali"><i class="fas fa-reply"></i> Kembali</button></a>
              <!-- End Control -->
              <div class="card mt-3">
              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <?php  } else { ?>
                    ...
                    <a href="<?php echo base_url().'dca/kuesioner/'.$read1->id; ?>" class="btn btn-primary btn-lg btn-block"><i class="ion-ios-arrow-right"></i> Isi Kuesioner Pelayanan</a>
