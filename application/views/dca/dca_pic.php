            ...
            <script type="text/javascript">
              ...
              $(document).ready(function() {
                  ...
                  table = $('#table').DataTable({ 
                      ...
                      "ajax": {
                          "url": "<?php echo site_url('pic/dca/ajax_list')?>",
                          "type": "POST",
                          "data": function ( data ) {
                  ...
                  table_customer = $('#table_customer').DataTable({ 
                      ...
                      "ajax": {
                          "url": "<?php echo site_url('pic/dca/customer_list')?>",
                          "type": "POST",
                          "data": function ( data ) {
                              data.nama_lengkap = $('#ff_nama').val();
                              data.nama_korporat = $('#ff_korporat').val();
                          }
                      },
              ...
              function show_data_customer()
              {
                ...
                $('.modal-title').text('Data Pelanggan Customer');

              }

              function pick_customer($customer_id, $customer_nama, $customer_korporat)
              {
                document.getElementById("customer_id").value = $customer_id;
                document.getElementById("dataCustomer").value = $customer_nama + '(' + $customer_korporat + ')';
              ...
              {
                  $.ajax({
                      url : "<?php echo site_url('pic/dca/ajax_detail')?>/" + id,
                      type: "GET",
                      dataType: "JSON",
                      success: function(data)
                      {
                          ...
                          if (data.status_activity == 'WAIT') {
                            ...
                            $('#btnRemark').html('<a href="<?php echo base_url('pic/dca/remark/')?>'+ id +'" target="_blank"><button class="btn btn-primary btn-block btn-lg"><i class="ion-ios-arrow-right"></i> Detail Aktivitas DCA</button></a>');
              ...
              function edit_dca(id)
              {
                  ...
                  $.ajax({
                      url : "<?php echo site_url('pic/dca/ajax_edit')?>/" + id,
                      type: "GET",
                      dataType: "JSON",
                      success: function(data)
                      {
              ...
              function delete_dca(id)
              {
                  if(confirm('Apakah anda yakin akan menghapus data ini?'))
                  {
                      ...
                      $.ajax({
                          url : "<?php echo site_url('pic/dca/ajax_delete')?>/"+id,
                          type: "POST",
                          dataType: "JSON",
                          success: function(data)
                          {
                              //if success reload ajax table
                              document.location = "<?php echo base_url('pic/dca')?>";
                          },
                          error: function (jqXHR, textStatus, errorThrown)
                          {
                  ...
                  if(list_id.length > 0)
                  {
                      if(confirm('Apakah anda yakin akan menghapus '+list_id.length+' data ini?'))
                      {
                          $.ajax({
                              type: "POST",
                              data: {id:list_id},
                              url: "<?php echo site_url('pic/dca/ajax_bulk_delete')?>",
                              dataType: "JSON",
                              success: function(data)
                              {
                                  if(data.status)
              ...
              function save()
              {
                  ...
                  if(save_method == 'add') {
                      url = "<?php echo site_url('pic/dca/ajax_add')?>";
                  } else {
                      url = "<?php echo site_url('pic/dca/ajax_update')?>";
                  }
                          ...
                          <form action="#" id="form" class="form-horizontal">
                              ...
                              <div class="form-body">
                                  <div class="form-group">
                                      <label class="control-label col-md-6">Pelanggan (Customer)</label>
                                      <div class="col-md-12">
                                        <div class="input-group">
                                            <input id="dataCustomer" name="dataCustomer" placeholder="Nama Pelanggan (Korporat)" class="form-control" type="text" required>
                                            <span class="input-group-append">
                                                <button class="btn btn-info" type="button" onclick="show_data_customer()">
                                  ...
                                  <h4>Keperluan</h4>
                                  <input type="hidden" name="pic_id" id="pic_id" value="<?php echo $this->session->userdata('id');?>">
                                  <div class="form-group">
                                  ...
                                  <h4>Keterangan</h4>
                                  <div class="form-group">
                                      <label class="control-label col-md-6">No. MOM</label>
                                      <div class="col-md-12">
                                        <input type="text" name="no_mom" class="form-control">
                                          <span class="help-block"></span>
                                      </div>
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-md-12">
                                          <select class="form-control" name="status_activity">
      ...
      <div class="modal fade" id="modal_customer" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body form">
                  <div class="table-responsive">
                      <table id="table_customer" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
                          <thead>
                            <tr>
                              <th class="text-center">
                                No.
