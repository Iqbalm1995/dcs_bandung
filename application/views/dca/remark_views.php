              ...
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  $cekKsrn      = $this->dca->cek($get_ksrn,'dcs_kuisioner')->result();
                    ...
                    <a href="<?php echo base_url().'admin/dca/result_angket/'.$read1->id; ?>" class="btn btn-primary btn-lg btn-block"><i class="ion-ios-arrow-right"></i> Hasil Kuisioner Pelayanan</a>
                  ...
                  <?php  } else { ?>
                    ...
                    <a href="<?php echo base_url().'admin/dca/kuesioner/'.$read1->id; ?>" class="btn btn-primary btn-lg btn-block"><i class="ion-ios-arrow-right"></i> Hasil Kuisioner Pelayanan</a> -->
