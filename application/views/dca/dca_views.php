            ...
            <script type="text/javascript">
              ...
              $(document).ready(function() {
                  ...
                  table = $('#table').DataTable({ 
                      ...
                      "ajax": {
                          "url": "<?php echo site_url('admin/dca/ajax_list')?>",
                          "type": "POST",
                          "data": function ( data ) {
                  ...
                  table_customer = $('#table_customer').DataTable({ 
                      ...
                      "ajax": {
                          "url": "<?php echo site_url('admin/dca/customer_list')?>",
                          "type": "POST",
                          "data": function ( data ) {
                  ...
                  table_pic = $('#table_pic').DataTable({ 
                      ...
                      "ajax": {
                          "url": "<?php echo site_url('admin/dca/pic_list')?>",
                          "type": "POST",
                          "data": function ( data ) {
              ...
              {
                  $.ajax({
                      url : "<?php echo site_url('admin/dca/ajax_detail')?>/" + id,
                      type: "GET",
                      dataType: "JSON",
                      success: function(data)
                      {
                          ...
                          if (data.status_activity == 'WAIT') {
                            ...
                            $('#btnRemark').html('<a href="<?php echo base_url('admin/dca/remark/')?>'+ id +'" target="_blank"><button class="btn btn-primary btn-block btn-lg"><i class="ion-ios-arrow-right"></i> Detail Aktivitas DCA</button></a>');
              ...
              function edit_dca(id)
              {
                  ...
                  $.ajax({
                      url : "<?php echo site_url('admin/dca/ajax_edit')?>/" + id,
                      type: "GET",
                      dataType: "JSON",
                      success: function(data)
                      {
              ...
              function delete_dca(id)
              {
                  if(confirm('Apakah anda yakin akan menghapus data ini?'))
                  {
                      ...
                      $.ajax({
                          url : "<?php echo site_url('admin/dca/ajax_delete')?>/"+id,
                          type: "POST",
                          dataType: "JSON",
                          success: function(data)
                          {
                              //if success reload ajax table
                              document.location = "<?php echo base_url('admin/dca')?>";
                          },
                          error: function (jqXHR, textStatus, errorThrown)
                          {
                  ...
                  if(list_id.length > 0)
                  {
                      if(confirm('Apakah anda yakin akan menghapus '+list_id.length+' data ini?'))
                      {
                          $.ajax({
                              type: "POST",
                              data: {id:list_id},
                              url: "<?php echo site_url('admin/dca/ajax_bulk_delete')?>",
                              dataType: "JSON",
                              success: function(data)
                              {
                                  if(data.status)
              ...
              function save()
              {
                  ...
                  if(save_method == 'add') {
                      url = "<?php echo site_url('admin/dca/ajax_add')?>";
                  } else {
                      url = "<?php echo site_url('admin/dca/ajax_update')?>";
                  }
